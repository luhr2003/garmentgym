...
def generate_four_points_heatmap_xml_for_mitsuba(
    ...
    def colormap(feature, pts,
        ...
        limit1 = np.random.uniform(0.11,0.17)
        limit2 = np.random.uniform(0.11,0.17)
        limit3 = np.random.uniform(0.11,0.17)
        limit4 = np.random.uniform(0.11,0.17)
        for i in range(pts.shape[0]):
            ...
            a=np.random.uniform(0.05, limit1)
            b=np.random.uniform(0.05, limit2)
            c=np.random.uniform(0.05, limit3)
            d=np.random.uniform(0.05, limit4)
            if distance1< a:
